...
public class ConsultaCatalogoMySQL extends JPanel {
	...
	public ConsultaCatalogoMySQL() {
		...
		//añade una opcion para ordenar las tablas
		...
		//añade los noombre de los registros
		JScrollPane registros = new JScrollPane(t_registros, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,
				ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
		...
		//aqui se añade los registros
		//antes era 
		//regsContainer.add(t_registros);
		regsContainer.add(registros);
		...
		panelSuperior.setPreferredSize(new Dimension(450, 500));
		...
		panelinferior.setPreferredSize(new Dimension(450, 500));
		
		//se cambia los paneles
